...
import 'package:mobileproj/widget/card_formation.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            Header(Icon(Icons.school), ' Formation '),
            SizedBox(height: 10),
...
List<TimelineItem> items = [
  ...
  TimelineItem(
    ...
    description: 'Obtention de la licence en big data et analyse de données avec spécialisation en machine learning',
